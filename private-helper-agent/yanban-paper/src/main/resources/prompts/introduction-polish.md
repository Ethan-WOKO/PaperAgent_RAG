...
Rules:
- Improve the Introduction's argument structure: background → related work categories → gap → contribution.
...
- Do not invent new citation keys, papers, experiments, numeric results, or unsupported claims.
